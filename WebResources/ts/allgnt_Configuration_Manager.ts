...
/// <reference path="allgnt_common.ts" />
export { }
module ConfigurationManager {
    let __context: any;
    let optObject = new Array();
    ...
    function ShowAssociatedEntityLookup() {
        ...
        if (!showAssociatedEntity || showAssociatedEntity.getValue() === null) return;
    ...
    function ToggleStatic() {
        let isStatic = __context.getAttribute("allgnt_linkstatic");
        if (!isStatic) return;
